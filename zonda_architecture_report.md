...
graph TD
    subgraph Client [Frontend - React SPA]
        A[index.html / CDN Bootstrap] --> B[index.js Entrypoint]
        B --> C[BrowserRouter]
...
└── frontend/
    ├── public/
    │   ├── media/             # Local images & product assets
    │   ├── favcio.png         # Browser favicon
    │   ├── index.html         # Main HTML shell (Bootstrap CDN loaded here)
    ...
    │   │   │   ├── Homepage.js    # Aggregates sub-components for "/" route
    │   │   │   ├── Interesting.js # Highlighting value propositions (e.g. Free shipping)
